...
**Figures** - hosts the data, and visualisation code (i.e. gif making code) used to produce each figure in the accompanying manuscript. See /Figures/README.md for code documentation, including data formats, dependencies and script structure. <br>
