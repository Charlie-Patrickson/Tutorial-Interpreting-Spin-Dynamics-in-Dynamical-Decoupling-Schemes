...
data = pd.read_csv("Rotating Spin Lock.csv")
Noisy_data = pd.read_csv("Detuned Rotating Spin Lock.csv")
data = [data, Noisy_data]
Spin_colours = ['#7701A8', '#EE7C50', 'grey', 'darkgrey', 'lightgrey']

Total_No_of_data_points = 833
...
for i in range(0, Total_No_of_data_points, Skip_lines+1):
    ...
    ax3.set_ylabel(f"X-Projection of Spin Vector", fontsize=18)
...
imageio.mimsave("Fig_4c.gif", images, duration=50)  # Adjust duration as needed
