...
def Plot_Bloch_trajectories(i, Signal_color, linewidth, ax, arrowhead_size, data, drive_colour_x, drive_colour_z, Signal_Max_Y, Detunings, spin_colours='k', ax2b = None, ax2a = None, ax3b = None, ax3a = None):
    ...
    for df in data:
        ...
        if ax2b:
            ax2b.plot(time[0:i], z[0:i], color = spin_colours[index], label =  Detunings[index])
            ax2b.legend(fontsize=16, title="Detuning:", title_fontsize=16) 
            
        if ax3b:
            ax3b.plot(time[0:i], x[0:i], color = spin_colours[index], label =  Detunings[index])
        ...
        if ax2a and index==1:
            #ax2a.plot(time[0:i], drive_x[0:i], color = drive_colour_x, label=r"$H_x^{\prime}$")
            ax2a.plot(time[0:i], drive_y[0:i], color = "#3F9765", label=r"$H_y^{\prime}$")
            ax2a.legend(fontsize=16) 
        
        if ax3a and index==1:
            #ax3a.plot(time[0:i], drive_x[0:i], color = drive_colour_x, label=r"$H_x^{\prime}$")
            ax3a.plot(time[0:i], drive_y[0:i], color = "#3F9765", label=r"$H_y^{\prime}$")
