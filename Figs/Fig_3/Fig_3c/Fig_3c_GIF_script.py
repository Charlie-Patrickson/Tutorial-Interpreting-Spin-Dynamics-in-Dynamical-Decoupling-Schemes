...
Noisy_data1 = pd.read_csv("Fig3c_Noisy Rotating Ramsey1.csv")
Noisy_data2 = pd.read_csv("Fig3c_Noisy Rotating Ramsey2.csv")
Noisy_data3 = pd.read_csv("Fig3c_Noisy Rotating Ramsey3.csv")
Noisy_data4 = pd.read_csv("Fig3c_Noisy Rotating Ramsey4.csv")
Noisy_data5 = pd.read_csv("Fig3c_Noisy Rotating Ramsey5.csv")
...
for i in range(0, Total_No_of_data_points, Skip_lines+1):
    ...
    ax2.set_ylabel(r"$S_z^{\prime}$", fontsize=18)
    ...
    ax3.set_ylabel(r"$S_x^{\prime}$", fontsize=18)
...
imageio.mimsave("Noisy Rotating Ramsey.gif", images, duration=50)  # Adjust duration as needed
