...
def Make_solid_outer_circle(Tilt_angle, ax, linewidth):
    ...
    ax.plot(vector[0], vector[1], vector[2], linestyle='solid', linewidth=linewidth, color="grey")
...
def Plot_Bloch_trajectories(i, Signal_color, linewidth, ax, arrowhead_size, data, drive_colour_x, drive_colour_z, Signal_Max_Y, Detunings, spin_colours='k', ax2b = None, ax3b = None, ax2a = None, ax3a = None):
    ...
    if ax2a:
        ax2a.plot(time[0:f], drive_x[0:f], color = drive_colour_x, label=r"$H_x^{\prime}$")
        ax2a.plot(time[0:f], drive_y[0:f], color = "#3F9765", label=r"$H_y^{\prime}$")
        ax2a.legend(fontsize=16) 
    
    if ax3a:
        ax3a.plot(time[0:f], drive_x[0:f], color = drive_colour_x, label=r"$H_x^{\prime}$")
        ax3a.plot(time[0:f], drive_y[0:f], color = "#3F9765", label=r"$H_y^{\prime}$")
