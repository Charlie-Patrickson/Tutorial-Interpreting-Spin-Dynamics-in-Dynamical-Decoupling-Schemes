...
data = [pd.read_csv("Fig_6b_Sim_Data_1.csv")]
Total_No_of_data_points = 1500
...
for i in range(0, Total_No_of_data_points, Skip_lines+1):
    ...
    ax2.set_ylabel(r"$S_y^{\prime}$", fontsize=22)
...
imageio.mimsave("Fig_6b.gif", images, duration=100)  # Adjust duration as needed
'''
  
with imageio.get_writer("Fig_6b.gif", mode="I", duration=50) as writer:
