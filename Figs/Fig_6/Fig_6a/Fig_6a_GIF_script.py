...
arrowhead_size = 24
Signal_Max_Y = 0.75
drive_colour_z = "#449AAE"
drive_colour_x = "#CA2C20"
Signal_color = "#218D8C"
Spin_colours = ['k', 'dimgrey', 'grey', 'darkgrey', 'lightgrey']

data = [pd.read_csv("Fig_6a_Sim_Data_1.csv")]
Total_No_of_data_points = 249
...
for i in range(0, Total_No_of_data_points, Skip_lines+1):
    ...
    ax2 = fig.add_axes([0.5, 0.2, 0.4, 0.7]) # [left, bottom, width, height]
    ...
    ax3.set_ylabel(r"$\Omega_z$", fontsize=22)
    ...
    BSfcs.Plot_Bloch_trajectories(i, Signal_color, linewidth, ax1, arrowhead_size, data, drive_colour_x, drive_colour_z, Signal_Max_Y, Spin_colours, ax2, ax3=None)
...
imageio.mimsave("Fig_6a.gif", images, duration=75)  # Adjust duration as needed
'''

with imageio.get_writer("Fig_6a.gif", mode="I", duration=75) as writer:
