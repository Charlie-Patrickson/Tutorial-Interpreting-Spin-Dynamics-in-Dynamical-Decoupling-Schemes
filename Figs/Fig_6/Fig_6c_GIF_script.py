...
Signal_color = "#218D8C"
Spin_colours = ['#2406A2', '#A01B9B', '#F1814C', '#FAD524', 'k']

Noisy1 = pd.read_csv("Fig_6c_Sim_Data_1.csv")
Noisy2 = pd.read_csv("Fig_6c_Sim_Data_2.csv")
Noisy3 = pd.read_csv("Fig_6c_Sim_Data_3.csv")
Noisy4 = pd.read_csv("Fig_6c_Sim_Data_4.csv")
data = [Noisy1, Noisy2, Noisy3, Noisy4]
Total_No_of_data_points = 2450
...
for i in range(0, Total_No_of_data_points, Skip_lines+1):
    ...
    ax2.set_ylabel(r"$S_z^{\prime}$", fontsize=22)
    ...
    ax3.set_ylabel(r"$\Omega_x^{\prime}$", fontsize=22)
...
imageio.mimsave("Noisey T2 Dephasing.gif", images, duration=50)  # Adjust duration as needed
